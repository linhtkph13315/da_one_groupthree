...
class PHPMailer
{
    ...
    /**
     * What to put in the X-PHPMailer header.
     ...
     * Uses the sending method specified by $PHPMailer.
     *
     * @throws Exception
     *
    ...
    public function setLanguage($langcode = 'en', $lang_path = '')
    {
        ...
        $PHPMAILER_LANG = [
            ...
            'variable_set' => 'Cannot set or forgot-password variable: ',
        ];
        if (empty($lang_path)) {
    ...
    public function createHeader()
    {
        ...
        if ('' === $this->XMailer) {
            ...
            if ($myXmailer) {
                $result .= $this->headerLine('X-PHPMailer', $myXmailer);
            }
        }
    ...
    /**
     * Set or forgot-password instance properties.
